...
fn entry(input: &str, name: &str) -> i32 {
    ...
    for (symbol_row, symbols) in symbol_vec.iter().enumerate() {
    ...
    let mut total = 0;
    for number_vec_row in number_vec {
        for number in number_vec_row {
            println!("{:?}", number);
            if number.seen {
                total += number.value;
            }
...
use either::*;
#[test]
pub fn test_aoc_2023_03_1_handle_symbol_or_number() {
...
#[test]
#[named]
pub fn test_aoc_2023_03_1_entry() {
    let input = "467..114..
...*......
..35..633.
......#...
